 ...
 */
public class ItemItemCollaborativeFilteringMain {
    ...
    public static void main(String[] args) {
    	...
    	/* Testing the Prediction of Item-Item Collaborative Filtering */
//    	args = "1024:77 1024:268 1024:462 1024:393 1024:36955 2048:77 2048:36955 2048:788".split(" ");
//    	args = ("485:2164 485:134 485:581 485:629 485:8358 "
//    			+ "313:63 313:161 313:268 313:745 313:14 "
//    			+ "377:581 377:424 377:2024 377:1891 377:278 "
//    			+ "3425:197 3425:1900 3425:568 3425:597 3425:424 "
//    			+ "3418:194 3418:107 3418:550 3418:134 3418:680").split(" ");
    	
    	/* Testing the Basket recommendation of the Item-Item CF-based recommender */
//    	args = ("--basket 77").split(" ");
//    	args = ("--basket 77 680").split(" ");
    	args = ("--basket 4327 680").split(" ");
    ...
    private static LenskitConfiguration configureRecommender() {
        ...
        config.set(RatingFile.class)
              .to(new File("data/assignment5/ratings.csv"));
        ...
        config.set(TitleFile.class)
              .to(new File("data/assignment5/movie-titles.csv"));
        ...
        config.set(UserFile.class)
              .to(new File("data/assignment5/users.csv"));
