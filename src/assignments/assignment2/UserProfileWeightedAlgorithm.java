...
public class UserProfileWeightedAlgorithm implements IUserProfileType {

	private double positiveRatingThreshold;

	public UserProfileWeightedAlgorithm(double positiveRatingThreshold) {
	...
	public void updateUserProfile(MutableSparseVector userProfile,
        ...
        if (p != null && p.getValue() >= positiveRatingThreshold) {
        	...
        	itemVector.multiply(p.getValue() - userRatingsMean);
