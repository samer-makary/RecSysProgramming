 ...
 * item.
 *
 * @see ContentBasedDataModelBuilder
...
@DefaultProvider(ContentBasedDataModelBuilder.class)
public class ContentBasedDataModel implements Serializable {
     ...
     * the {@linkplain ContentBasedDataModelBuilder model builder}.
     * <p>
     ...
     */
    ContentBasedDataModel(Map<String,Long> tagIds, Map<Long,SparseVector> itemVectors) {
        this.tagIds = tagIds;
